...
public class HamiltonianCycleCalculator {
    ...
    public static int successful = 0; //Keeps track of the amount of successful cycles generated by this class.
    ...
    /**
     * Constructor for a new hamiltonian cycle calculator.
     * @param size
     */
    public HamiltonianCycleCalculator(int size){
        nodeAmount = size;
    }
    ...
    private String calculateCycleString(CycleNode[] nodes){
        ...
        CycleNode last = first.getNeighbours()[1];
        CycleNode previous;
        ...
        cycleOutput += last.toString();
        return cycleOutput;
    }

    /**
     * Computes a cycle with the computed Yutsis-decomposition.
     * @return A hamiltonian cycle, null if no hamiltonian cycle could be found.
     */
    public CycleNode[] calculateCycle(PlaneNodeArray tree){
        if(tree==null){
            return null;
        }
        ...
        for(PlaneNode planeNode: tree.getNodes()){ //Loop trough all planes of the tree.
            ...
            for(Plane neighbour: plane.getAdjacentPlanes()){
                ...
                if(!neighbour.getNode().isPresent(tree)){
                    Node[] nodes = plane.getCommonEdge(neighbour).getEndPoints();
                    int i=0;
    ...
    public boolean isCycle(CycleNode[] cycle) {
        ...
        for(CycleNode cycleNode: cycleNodes){
            ...
            //Check if a cyclenode doesn't have precisely 2 edges leading to other cyclenodes.
