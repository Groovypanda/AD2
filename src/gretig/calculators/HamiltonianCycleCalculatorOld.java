...
public class HamiltonianCycleCalculatorOld {
    ...
    public Edge[] getAdjacentPlane(Edge edge){
        ...
        plane[0] = edge;
        plane[1] = plane[0].getNextEdge(plane[0].getEndPoints()[0]);
        plane[2] = plane[0].getPreviousEdge(plane[0].getEndPoints()[1]);
        if(plane[1].isVisited() && plane[2].isVisited()){
            plane[1] = plane[0].getNextEdge(plane[0].getEndPoints()[1]);
            plane[2] = plane[0].getPreviousEdge(plane[0].getEndPoints()[0]);
        }
        return plane;
    }
    ...
    public void initiateCycle(Cycle cycle, Edge start){
        ...
        cycleEdges[1] = new CycleEdge(start.getNextEdge(start.getEndPoints()[1]));
        cycleEdges[2] = new CycleEdge(start.getPreviousEdge(start.getEndPoints()[0]));
