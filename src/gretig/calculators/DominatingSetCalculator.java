...
public class DominatingSetCalculator {
    ...
    // it covers the whole graph, in other words the amount of unique nodes with their neighbours equals the planeAmount of all nodes.
    ...
    public boolean isDominant(List<Node> dominantList){
        ...
        coverage.addAll(dominantList); //Adding all graph to set to remove doubles.
